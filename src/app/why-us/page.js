            ...
            <div className="col-7 my-auto">
              <div className="homeLeftContent">
                ...
                <p className="textDark">
                  ...
                  and vehicle before the ride begins. Drivers see daily earnings
                  right on their home screen and receive automatic weekly
                  payments. No hidden fees, no complicated algorithms, just
            ...
            <div className="col-7 my-auto">
              <div className="homeLeftContent">
                ...
                <p className="">
                  ...
                  without sharing private phone numbers. Our verification system
                  ensures everyone on the platform meets our standards, while
                  our 24/7 support team stands ready to assist with any concerns
          ...
          <div className="row ">
            ...
            <div className="col-7 my-auto">
              <div className="homeLeftContent">
                ...
                <p className="textDark">
                  Every ride is an opportunity to connect. Our rating system
                  helps maintain quality and build trust between passengers and
                  drivers. Share routes to make transportation more efficient
                  and affordable. Together, we're creating a more connected,
            ...
            <div className="col-7 my-auto">
              <div className="homeLeftContent">
                ...
                <p className="">
                  ...
                  with a few taps, manage your schedule in one place, and enjoy
          ...
          <div className="row ">
            ...
            <div className="col-7 my-auto">
              <div className="homeLeftContent">
                ...
                <p className="textDark">
                  Great service deserves recognition. Drivers build their
